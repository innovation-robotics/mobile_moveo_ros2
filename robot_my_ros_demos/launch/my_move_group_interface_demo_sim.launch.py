...
def generate_launch_description():
    ...
    move_group_demo = Node(
        ...
        package="robot_my_ros_demos",
        executable="my_pick_and_place_trial",
        output="screen",
        # prefix=["gdbserver localhost:3000"],
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, joint_limits_yaml,{"use_sim_time": True}],
    )
